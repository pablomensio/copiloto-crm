...
import { Search, Filter, PlusCircle, Upload, GitCompare } from 'lucide-react';
...
interface InventoryViewProps {
  ...
  onCreateMultiBudget?: () => void;
  markup: number;
}

const InventoryView: React.FC<InventoryViewProps> = ({ vehicles, onVehicleSelect, onAddVehicleClick, onBulkUploadClick, onCreateMultiBudget, markup }) => {
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        ...
        <div className="flex flex-col md:flex-row gap-3">
          ...
          <div className="flex gap-2">
            {onCreateMultiBudget && (
              <button
                onClick={onCreateMultiBudget}
                className="flex items-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-lg text-sm font-medium hover:bg-purple-700 shadow-lg shadow-purple-200 whitespace-nowrap transition-colors"
              >
                <GitCompare size={18} />
