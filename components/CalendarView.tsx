    ...
    for (let day = 1; day <= days; day++) {
      ...
      grid.push(
        <div 
          ...
          className={`h-24 border border-gray-100 p-2 cursor-pointer transition-colors relative hover:bg-indigo-50/30 ${
        ...
        >
          ...
          <div className="mt-2 space-y-1">
             {dayTasks.slice(0, 3).map(task => (
                 <div key={task.id} className={`text-[10px] truncate px-1 py-0.5 rounded border-l-2 ${
