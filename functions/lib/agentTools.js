...
exports.toolCrearTarea = exports.toolAbrirCalculadora = exports.toolEnviarFicha = exports.toolBuscarVehiculos = void 0;
 ...
 */
exports.toolBuscarVehiculos = functions.https.onRequest(async (req, res) => {
    // Configurar CORS
 ...
 */
exports.toolEnviarFicha = functions.https.onRequest(async (req, res) => {
    res.set('Access-Control-Allow-Origin', '*');
    res.set('Access-Control-Allow-Methods', 'POST, OPTIONS');
    res.set('Access-Control-Allow-Headers', 'Content-Type');
    if (req.method === 'OPTIONS') {
 ...
 */
exports.toolAbrirCalculadora = functions.https.onRequest(async (req, res) => {
    res.set('Access-Control-Allow-Origin', '*');
    res.set('Access-Control-Allow-Methods', 'POST, OPTIONS');
    res.set('Access-Control-Allow-Headers', 'Content-Type');
    if (req.method === 'OPTIONS') {
    ...
    try {
        ...
        if (vehiculo_id)
            params.append('vehiculo', vehiculo_id);
        if (monto)
            params.append('monto', monto.toString());
        if (params.toString()) {
 ...
 */
exports.toolCrearTarea = functions.https.onRequest(async (req, res) => {
    res.set('Access-Control-Allow-Origin', '*');
    res.set('Access-Control-Allow-Methods', 'POST, OPTIONS');
    res.set('Access-Control-Allow-Headers', 'Content-Type');
    if (req.method === 'OPTIONS') {
