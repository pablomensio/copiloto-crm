...
async function main() {
    ...
    try {
        const response = await axios_1.default.post(setWebhookUrl, { webhook: webhookUrl }, {
            headers: {
                "x-maytapi-key": token,
        ...
        console.error("Error configurando webook:", ((_a = e.response) === null || _a === void 0 ? void 0 : _a.data) || e.message);
    }
}
main();
//# sourceMappingURL=configureWebhook.js.map