...
// dotenv.config();
exports.webChat = (0, https_1.onRequest)({
    cors: true,
    region: "us-central1",
    memory: "512MiB",
    timeoutSeconds: 60
    ...
    try {
        ...
        const inventario = await (0, messageHandler_1.obtenerInventarioActualizado)();
        ...
        const agenteResponse = await (0, agentClient_1.enviarMensajeAlAgente)(chatId, message, {
            nombre: "Cliente Web",
            telefono: "N/A",
        ...
        if (error.message && (error.message.includes("Token limit") || error.message.includes("FAILED_PRECONDITION"))) {
            ...
            try {
                ...
                const resumenMinimo = inventario
                    ...
                    .join("; ");
                const retryResponse = await (0, agentClient_1.enviarMensajeAlAgente)(newSessionId, message, {
                    nombre: "Cliente Web",
                    telefono: "N/A",
                    historial: "",
...
//# sourceMappingURL=webChatEndpoint.js.map